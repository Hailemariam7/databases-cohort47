...
CREATE TABLE Recipes (
    recipe_id INT PRIMARY KEY AUTO_INCREMENT, recipe_name VARCHAR(255) NOT NULL, cooking_time INT, -- in minutes
    preparation_time INT, -- in minutes
    spiciness INT -- scale of 1-5, 1 being not spicy, 5 being very spicy (ENUM(1, 2, 3, 4, 5))
);
...
CREATE TABLE RecipeIngredients (
    recipe_id INT, ingredient_id INT, quantity DECIMAL(10, 2), -- e.g., 1.5, 100, etc.
